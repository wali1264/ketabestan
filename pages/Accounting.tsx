...
import { PlusIcon, XIcon, EyeIcon } from '../components/icons';
...
const SuppliersTab = () => {
    const { suppliers, addSupplier, addSupplierPayment, supplierTransactions, storeSettings } = useAppContext();
...
const CustomersTab = () => {
    const { customers, addCustomer, addCustomerPayment, customerTransactions, storeSettings } = useAppContext();
    const [isAddModalOpen, setIsAddModalOpen] = useState(false);
    const [isPayModalOpen, setIsPayModalOpen] = useState(false);
